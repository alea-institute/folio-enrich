...
class TestDependencyParser:
    def test_extract_triples_basic(self):
        ...
        triples, pos_data, _ner = parser.extract_triples_and_pos(text)
    ...
    def test_extract_triples_returns_spo_triple_objects(self):
        ...
        triples, _, _ = parser.extract_triples_and_pos(text)
        for t in triples:
    ...
    def test_pos_data_returned(self):
        ...
        _, pos_data, _ = parser.extract_triples_and_pos(text)
